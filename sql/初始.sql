...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-07-27 19:38:48', 'admin', '2024-07-26 17:28:35', '', '2024-07-27 19:38:48', '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '点位表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `tb_partner` VALUES (1, '合作商A', '张三', '13800138000', 30, 'a001', 'pwdA', '2024-07-27 19:42:55', '2024-07-27 19:42:55', NULL, NULL, NULL);
...
CREATE TABLE `tb_region`  (
  ...
  `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '区域表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_region
-- ----------------------------
INSERT INTO `tb_region` VALUES (1, '北京市朝阳区', '2024-07-27 19:42:55', '2024-07-27 19:42:55', NULL, NULL, '北京市朝阳区');
INSERT INTO `tb_region` VALUES (2, '北京市海淀区', '2024-07-27 19:42:55', '2024-07-27 19:42:55', NULL, NULL, '北京市海淀区');
INSERT INTO `tb_region` VALUES (3, '北京市东城区', '2024-07-27 19:42:55', '2024-07-27 19:42:55', NULL, NULL, '北京市东城区');
