<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <!--<el-table-column label="设备数" align="center" prop="vmCount" />-->
    ...
    <!--查看详情对话框-->
    <el-dialog title="点位详情" v-model="infoOpen" width="500px" append-to-body>
      <el-table :data="vmList">
        ...
        <el-table-column label="最后一次供货时间" align="center" prop="lastSupplyTime" width="160">
          <template #default="scope">
...
const handleShowInfo = async (row) => {
  const { rows } = await listVm({ pageNum: 1, pageSize: 1000, nodeId: row.id })
  vmList.value = rows
  infoOpen.value = true
}
