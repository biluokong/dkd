<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="handleShowInfo(scope.row)" v-hasPermi="['manage:node:list']">查看详情</el-button>
    ...
    <!--查看详情对话框-->
    <el-dialog :title="title" v-model="infoOpen" width="500px" append-to-body>
      <el-form ref="regionRef" :model="form">
        <el-form-item label="区域名称：" prop="regionName">
...
const handleShowInfo = async (row) => {
  ...
  // 2.获取点位列表
  const { rows } = await listNode({ pageNum: 1, pageSize: 1000, regionId: row.id})
  nodeList.value = rows
  infoOpen.value = true
}
